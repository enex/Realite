...
export default async function NewEventEntryPage() {
  ...
  if (!user) {
    ...
    return (
      <main className="mx-auto flex min-h-dvh max-w-2xl flex-col justify-center px-6 py-12">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">Event-Entry anlegen</h1>
  ...
  return (
    <SinglesHereCreatePageWithConfig
      ...
      heading="Event-Entry anlegen"
      introText="Lege eine Event-Entry-Seite mit QR-Code an. Der Slug wird Teil der URL und muss eindeutig sein."
    />
  );
}
