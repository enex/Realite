...
export function Glass({
  ...
  // Use BlurView on iOS - GlassView doesn't handle background colors properly
  // The Card component uses a wrapper View for background, so BlurView works better here
  return (
    <BlurView
      intensity={intensity}
      tint={tint}
