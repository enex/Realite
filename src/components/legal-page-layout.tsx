  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <article className="rounded-2xl border border-border bg-card p-8 shadow-sm">
        ...
        <p className="mt-2 text-xs font-medium uppercase tracking-wide text-muted-foreground">Stand: {updatedAt}</p>
        <div className="mt-8 space-y-7 text-sm leading-7 text-foreground [&_h2]:mb-2 [&_h2]:text-lg [&_h2]:font-semibold [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6">
          {children}
        </div>
      </article>
    </main>
