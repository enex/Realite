...
Der Login kann je nach Deployment technisch über Google, Apple oder Microsoft starten. Wenn Google und Apple verfügbar sind, erscheinen beide bewusst als normale Kontopfade auf derselben Ebene. In lokaler Entwicklung gibt es zusätzlich einen dev-only Testzugang. Die Produktlogik in Realite bleibt davon getrennt: Events, Gruppen, Vorschläge und Sichtbarkeit laufen über denselben Kernflow.
...
- **Smart Treffen** findest du in **Events** als nachgelagerten Planungs- und Orga-Bereich, nicht als eigenen Hauptnavigationspunkt und nicht im spontanen Hauptfeed
